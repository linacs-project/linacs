...
must be exportable from :linacs.api (i.e. findable there as EXTERNAL)."
  (let ((api (find-package :linacs.api))
        (need '("DEFINE-HOME" "DEFINE-PROFILE" "USE-FEATURE" "PACKAGE-PREFERENCE"
                ...
                "CRON" "COMMAND" "CLONE" "STOW" "REPOSITORY"
                ...
                "SAME-ACTION-CONTENT-P" "ACTION-PRIORITY" "ACTION-FORCE"
                "ACTION-DISABLED" "ACTION-DEPENDS-ON" "ACTION-SOURCE"
                "ACTION-LOCATION" "ACTION-PROJECT-ROOT" "ACTION-MODE"
